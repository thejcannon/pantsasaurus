...
<CaptionedImg src={require("./splash.png").default}>Terminal output of a Pants run that retrieved test results from a remote cache instead of having to run the tests.</CaptionedImg>
