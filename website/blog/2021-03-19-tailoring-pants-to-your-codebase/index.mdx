...
<CaptionedImg src={require("./splash.jpg").default}>Photo by [Yasamine June](https://unsplash.com/@yasamine?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit) / [Unsplash](https://unsplash.com/?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit)</CaptionedImg>
