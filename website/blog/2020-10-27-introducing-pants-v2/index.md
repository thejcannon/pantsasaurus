...
<CaptionedImg src={require("./splash.jpg").default}>Photo by [Jess Bailey](https://unsplash.com/es/@jessbaileydesigns?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit) / [Unsplash](https://unsplash.com/?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit)</CaptionedImg>
