...
<CaptionedImg src={require("./splash.jpg").default}>Photo by [Ankush Minda](https://unsplash.com/@an_ku_sh?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit) / [Unsplash](https://unsplash.com/?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit)</CaptionedImg>
