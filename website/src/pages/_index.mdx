...
export const Row = ({ children }) => <div className="row padding-vert--md">{children}</div>
...
<p className="hero__subtitle">Welcome to the Pants 2 documentation hub!</p>
...
Here you'll find guides to help you get started with Pants 2, comprehensive documentation on how to
configure, run and customize Pants 2, and information on how to get help from the Pants community.
</div>
</header>
...
[generated](https://www.pantsbuild.org/docs/reference-tailor) and
[updated](https://www.pantsbuild.org/docs/reference-update-build-files) for you!
</Card>
...
[Learn more.](https://www.pantsbuild.org/docs/welcome-to-pants)
</Row>
...
and contributions. So [come say hi on the Slack](https://www.pantsbuild.org/docs/getting-help#slack)
...
and [more](https://www.pantsbuild.org/docs/media#case-studies).
</Card>
...
Slack, Salesforce, and [many others](https://www.pantsbuild.org/page/who-uses-pants).
</Card>
</Row>
