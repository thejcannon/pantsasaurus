...
<Testimonial author={{
  ...
  imageURL: "https://ca.slack-edge.com/T046T6T8L-U027TLRLSAV-8cf4485adc72-512",
}}>
I must say, it’s a life saver. I was impressed with how easy it was to migrate our current projects to Pants. Documentation is well written and the example repos ([example-python](https://github.com/pantsbuild/example-python) and [example-plugin](https://github.com/pantsbuild/example-plugin)) are good starting points. Right now we use Pants to manage 5 of our projects and our development process has improved a lot, especially the CI pipeline.
</Testimonial>
