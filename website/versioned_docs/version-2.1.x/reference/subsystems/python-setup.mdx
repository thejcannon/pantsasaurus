...
requirement syntax, e.g. &#x27;CPython&gt;=2.7,&lt;3&#x27; (A CPython
interpreter with version &gt;=2.7 AND version &lt;3) or &#x27;PyPy&#x27; (A
pypy interpreter of any version). Multiple constraint strings will be ORed
together. These constraints are used as the default value for the
`interpreter_constraints` field of Python targets.
