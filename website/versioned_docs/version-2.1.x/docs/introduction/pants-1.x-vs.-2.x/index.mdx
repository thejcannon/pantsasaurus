...
[block:callout]
{
  ...
  "body": "This page is intended for current Pants users still on the 1.x series. If you are trying Pants for a new project, you should already be using Pants 2.x, so you can ignore this page."
}
[/block]
