...
:::caution Issues finding files?
    ...
    Run `./pants dependencies --transitive path/to/binary.py` to ensure that all the files you need are showing up, including for any [resources](doc:resources) you intend to use.
