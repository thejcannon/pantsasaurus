...
- Substantial performance regressions (slowdown of >= 10%). \* If a new feature results in this slowdown, it should be put behind a flag that is disabled by default.
  ## Allowed changes
- Adding new options.
