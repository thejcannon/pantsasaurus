...
If you're using [Protobuf and gRPC](reference:reference-protobuf_source), you may want your editor to be able to index and navigate the generated source code.
...
We have not yet developed tight IDE integrations, such as a PyCharm plugin or a VSCode extension, that would allow the IDE to run Pants on your behalf. If you're interested in developing this functionality for your favorite IDE, [let us know](../getting-help/the-pants-community/index.mdx)!
