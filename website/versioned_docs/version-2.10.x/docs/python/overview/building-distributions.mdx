...
You configure a distribution using a [`python_distribution`](../../../reference/targets/python-distribution.mdx) target. This target provides Pants with the information needed to build the distribution.
