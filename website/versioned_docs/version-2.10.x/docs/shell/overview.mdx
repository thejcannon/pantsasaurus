...
Pants uses [`shell_source`](../../reference/targets/shell-source.mdx) and [`shunit2_test`](../../reference/targets/shunit2-test.mdx) [targets](../using-pants/key-concepts/targets-and-build-files.mdx) to know which Shell files you want to operate on and to set any metadata.
