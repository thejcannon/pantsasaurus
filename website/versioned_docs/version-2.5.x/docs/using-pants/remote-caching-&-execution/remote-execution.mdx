...
Run `./pants help-advanced global` or refer to [Global options](reference:reference-global). Most remote execution and caching options begin with the prefix `--remote`.
