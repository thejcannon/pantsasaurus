...
>
  ...
  https://www.pantsbuild.org/v2.15/docs/advanced-target-selection.
</Option>
...
>
  ...
  process (such as one opened using
  `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 run`) before killing
  it.
</Option>
...
>
  ...
  files. See https://www.pantsbuild.org/v2.15/docs/macros.
</Option>
