...
If true, don&#x27;t use Buildifier when running
`/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 fmt`.
...
Arguments to pass directly to Buildifier, e.g.
`--buildifier-args='-lint=fix'`.
