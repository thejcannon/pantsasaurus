...
You can use `pants package` to package your code into various formats, such as a [PEX binary](doc:python-package-goal), a [wheel](doc:python-distributions), an [AWS Lambda](doc:awslambda-python), or a [zip/tar archive](doc:assets).
