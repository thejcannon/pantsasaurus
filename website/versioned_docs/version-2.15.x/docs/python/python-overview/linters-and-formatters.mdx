...
See [`[pylint].source_plugins`](reference:reference-pylint#section-source-plugins) and [`[flake8].source_plugins`](reference:reference-flake8#section-source-plugins) for instructions to add plugins written by you.
