...
[/block]
Per our [Deprecation policy](doc:deprecation-policy), deprecations must last a minimum of one major release. For example, something may be deprecated in 2.1.0 and then removed in 2.2.0.
