...
<TabItem value="mypy-stubs/colors.pyi" label="mypy-stubs/colors.pyi">
...
<TabItem value="mypy-stubs/BUILD" label="mypy-stubs/BUILD">
...
<TabItem value="src/python/project/app.py" label="src/python/project/app.py">
...
<TabItem value="src/python/project/BUILD" label="src/python/project/BUILD">
...
<TabItem value="mypy.ini" label="mypy.ini">
...
<TabItem value="src/python/project/django_settings.py" label="src/python/project/django_settings.py">
...
```
Add `mypy_plugin = true` to the `[python-protobuf]` scope. See [Protobuf](doc:protobuf) for more information.
...
<TabItem value="pants-plugins/mypy_plugins/BUILD" label="pants-plugins/mypy_plugins/BUILD">
...
<TabItem value="pants-plugins/mypy_plugins/change_return_type.py" label="pants-plugins/mypy_plugins/change_return_type.py">
...
Please reach out on [Slack](doc:community) if you need support for namespace packages. We had difficulty getting MyPy to work with namespace packages independently of Pants, and it would help us to understand your use case.
