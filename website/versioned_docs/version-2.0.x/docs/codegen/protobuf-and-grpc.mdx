...
```text title="title="requirements.txt""
grpcio==1.32.0
protobuf>=3.12.1
```
...
<Tabs>
<TabItem value="src/proto/example/BUILD" label="src/proto/example/BUILD">
...
<TabItem value="src/proto/example/f.proto" label="src/proto/example/f.proto">
...
```python title="title="src/proto/example/BUILD""
...
<Tabs>
<TabItem value="src/python/example/BUILD" label="src/python/example/BUILD">
...
<TabItem value="src/python/example/app.py" label="src/python/example/app.py">
