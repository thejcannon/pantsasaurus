...
Use this when you expect a single value, but it is a non-primitive type. For example, use this with any [`objects`](doc:plugins-macros) you defined.
...
```python title="title="plugins/target_types.py""
from typing import Optional
