...
As described in [Targets and BUILD files](doc:targets), a _target_ is a set of metadata describing some of your code.
...
In fact, it only takes 3 lines of code to [create a new target](doc:target-api-new-targets):
[block:code]
{
  "codes": [
    {
      "code": "from pants.engine.target import Dependencies, Sources, Target, Tags\n\nclass CustomTarget(Target):\n    alias = \"custom_target\"\n    core_fields = (Sources, Dependencies, Tags)",
      "language": "python",
      "name": "plugin_target_type.py"
    }
  ]
}
[/block]
