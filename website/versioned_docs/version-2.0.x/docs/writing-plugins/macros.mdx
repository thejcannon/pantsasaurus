...
[block:code]
{
  "codes": [
    {
      "code": "def custom_python_library(has_type_hints: bool = True, **kwargs):\n    if has_type_hints:\n        kwargs[\"tags\"] = kwargs.get(\"tags\", []) + [\"type_checked\"]\n    python_library(**kwargs)",
      "language": "python",
      "name": "pants-plugins/macros.py"
    },
    {
      "code": "custom_python_library(\n    has_type_hints=False,\n)",
      "language": "python",
      "name": "project/BUILD"
    }
  ]
