...
{
  "type": "success",
  "title": "Help us to document how to set up your favorite editor",
  "body": "We'd love your help. You can either click \"Suggest edits\" in the top right corner of this page or message us on [Slack](doc:community)."
}
[/block]