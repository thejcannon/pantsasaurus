...
[block:callout]
{
  "type": "info",
  "title": "Examples",
  "body": "See the example-python repository for an [example .travis.yml](https://github.com/pantsbuild/example-python/blob/main/.travis.yml) and [example GitHub Actions worfklow](https://github.com/pantsbuild/example-python/blob/main/.github/workflows/pants.yaml)."
}
[/block]
...
* [`[python-setup].resolver_num_jobs`](doc:reference-python-setup#section-resolver-jobs): maximum number of concurrent jobs to build Python wheels with.
