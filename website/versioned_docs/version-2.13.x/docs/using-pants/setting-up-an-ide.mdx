...
If you're using [Protobuf and gRPC](../../reference/targets/protobuf-sources.mdx), you may want your editor to be able to index and navigate the generated source code. 
