...
Check out [Plugins Overview](../../writing-plugins/plugins-overview.mdx). We'd also love to help in the #plugins channel on [Slack](../../getting-help/the-pants-community/index.mdx).
...
Second, you can [configure](reference:reference-global#section-build-patterns) Pants to use a different set of file names entirely:
