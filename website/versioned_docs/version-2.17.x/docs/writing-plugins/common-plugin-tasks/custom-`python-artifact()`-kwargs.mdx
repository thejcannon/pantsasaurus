...
Pants can build [Python distributions](../../python/python-overview/building-distributions.mdx), such as wheels and sdists, from information you provide in a [`python_distribution`](reference:reference-python_distribution) target.
