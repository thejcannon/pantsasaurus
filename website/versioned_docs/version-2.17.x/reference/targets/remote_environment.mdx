...
<Field type_repr={`field.type_hint`} default_repr={`'linux_x86_64'`}>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.shell">
  Overrides the default value from the option
  `[shell-setup].executable_search_paths` when this environment target is
  active.
</Field>

## `go_generate_env_vars`

<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option `[go-generate].env_vars` when this
...
<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option `[golang].cgo_c_flags` when this
  environment target is active.
</Field>
...
>
  Overrides the default value from the option `[nodejs].search_path` when this
  environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option `[golang].cgo_fortran_flags` when
  this environment target is active.
</Field>

## `subprocess_environment_env_vars`

<Field type_repr={`field.type_hint`} backend="pants.core">
  Overrides the default value from the option
  `[subprocess-environment].env_vars` when this environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option `[golang].cgo_cxx_flags` when this
  environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.docker">
...
<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option
  `[golang].external_linker_binary_name` when this environment target is active.
</Field>

## `jvm_global_options`

<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.java">
  Overrides the default value from the option `[jvm].global_options` when this
  environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.core">
  Overrides the default value from the option `[test].extra_env_vars` when this
  environment target is active.
</Field>
...
>
  Overrides the default value from the option
  `[apache-thrift].thrift_search_paths` when this environment target is active.
</Field>
...
<Field
  ...
  backend="pants.backend.experimental.openapi.lint.spectral"
>
  Overrides the default value from the option `[nodejs].corepack_env_vars` when
  this environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option `[golang].cgo_linker_flags` when
  this environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.experimental.go">
  Overrides the default value from the option `[golang].go_search_paths` when
  this environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.backend.docker">
  Overrides the default value from the option `[docker].env_vars` when this
  environment target is active.
</Field>
...
<Field type_repr={`field.type_hint`} backend="pants.core">
  Overrides the default value from the option `[python-bootstrap].names` when
  this environment target is active.
</Field>
