...
If true, don&#x27;t use Pydocstyle when running `scie-pants-linux-x86_64
  lint`.
...
Arguments to pass directly to Pydocstyle, e.g.
`--pydocstyle-args='--select=D101,D102'`.
...
Path to a Pydocstyle config file
