...
Pants can build [Python distributions](../../python/python-overview/building-distributions.mdx), such as wheels and sdists, from information you provide in a [`python_distribution`](../../../reference/targets/python-distribution.mdx) target.
