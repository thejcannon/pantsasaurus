...
:::caution Failure to parse files?
    ...
    (Pants should autodiscover the config file `.coveragerc`. See [coverage-py](reference:reference-coverage-py#section-config-discovery).)
