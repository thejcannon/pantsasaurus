...
[block:callout]
{
  ...
  "body": "This documentation is for Pants v2, which is a ground-up redesign of Pants based on lessons from the past 10 years of development. See [here](https://v1.pantsbuild.org/) for Pants v1 documentation, which includes support for Node, Go, Java, and Scala."
}
[/block]
