...
:::tip Asking for help
    ...
    See [Getting Help](../../introduction/getting-help.mdx). We would love to help!
...
Once you have this stack trace, we recommend copying it into Pastebin or a GitHub Gist, then opening a GitHub issue or posting on Slack. Someone from the Pants team would be happy to help. See [Getting Help](../../introduction/getting-help.mdx).
