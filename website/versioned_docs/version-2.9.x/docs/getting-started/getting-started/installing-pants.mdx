...
[block:callout]
{
  ...
  "body": "We strongly recommend checking the `./pants` script into your repo. This will allow all users to use Pants without having to manually set up this script themselves."
}
[/block]
...
{
  "type": "success",
  "body": "The `./pants` script will automatically install and use the Pants version specified in `pants.toml`, so upgrading Pants is as simple as editing the version in that file.",
