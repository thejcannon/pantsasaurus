...
{
"type": "warning",
"body": "We are gathering feedback on this target before we promote it from its experimental status. Please reach out to us on [slack](https://join.slack.com/t/pantsbuild/shared_invite/zt-d0uh0mok-RLvVosDiX6JDpvStH~bFBA) or [GitHub](https://github.com/pantsbuild/pants) with your ideas or issues.",
