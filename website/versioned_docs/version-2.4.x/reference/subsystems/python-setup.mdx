...
<Option
  ...
  removal_hint={
    "Support for configuring --resolver-version and selecting pip's legacy resolver will be removed in Pants 2.5. Refer to https://pip.pypa.io/en/latest/user_guide/#changes-to-the-pip-dependency-resolver-in-20-2-2020 for more information on the new resolver."
  }
>
