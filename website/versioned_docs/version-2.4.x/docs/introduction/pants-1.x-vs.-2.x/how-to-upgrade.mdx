...
"type": "info",
"title": "Why upgrade?",
"body": "See [Pants 1.x vs. 2.0](./index.mdx)."
}
[/block]
...
"body": "Please message us on [Slack](/community/members) if you are having issues upgrading or find something missing. We would love to help."
}
[/block]
