...
Often, you will want to create a [`Subsystem`](doc:rules-api-subsystems) for your Python tool to allow users to set options to configure the tool. You can subclass `PythonToolBase`, which subclasses `Subsystem`, to do this:
