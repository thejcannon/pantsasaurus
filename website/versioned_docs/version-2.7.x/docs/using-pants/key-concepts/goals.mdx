...
To see if a goal has any options, run `./pants help $goal` or `./pants help-advanced $goal`. See [Command Line Help](../../learn-about-pants/getting-help.mdx) for more information.
