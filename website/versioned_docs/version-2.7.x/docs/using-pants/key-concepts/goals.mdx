...
[block:code]
{
  "codes": [
    {
      "code": "# Format all code, and then lint it:\n$ ./pants fmt lint ::\n\n..",
      "language": "text"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "# Re-run typechecking and testing continuously as files or their dependencies change:\n$ ./pants --loop typecheck test src/python/pants/util/dirutil_test.py\n\n..",
      "language": "text"
    }
  ]
}
