...
<TabItem value="src/python/hw/BUILD" label="src/python/hw/BUILD">
...
<TabItem value="src/python/hw/main.py" label="src/python/hw/main.py">
...
:::note Generating Tags
    ...
    Generating custom tags at runtime based on Git state or image inputs requires you to write some custom plugin code. Don't hesitate to [reach out](../learn-about-pants/getting-help.mdx) for help with this.
