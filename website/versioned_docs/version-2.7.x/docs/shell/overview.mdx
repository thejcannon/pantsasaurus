...
Unlike [with Python](../python/goals/test.mdx#timeouts), you cannot yet set a default or maximum timeout value, nor temporarily disable all timeouts. Please [let us know](../learn-about-pants/getting-help.mdx) if you would like this feature.
