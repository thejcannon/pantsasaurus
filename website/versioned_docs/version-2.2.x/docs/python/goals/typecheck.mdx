...
```python title="tab={"label":"mypy-stubs/colors.pyi"}"
...
```text title="tab={"label":"mypy-stubs/BUILD"}"
python_library()
```

```python title="tab={"label":"src/python/project/app.py"}"
...
```python title="tab={"label":"src/python/project/BUILD"}"
...
```python title="tab={"label":"src/python/project/django_settings.py"}"
...
```python title="tab={"label":"pants-plugins/mypy_plugins/BUILD"}"
mypy_source_plugin(
    name="plugin",
...
```python title="tab={"label":"pants-plugins/mypy_plugins/change_return_type.py"}"
