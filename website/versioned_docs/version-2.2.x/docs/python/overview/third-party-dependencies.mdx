...
{
  "type": "info",
  "title": "Requirements files with custom names",
  "body": "Your requirements file doesn't have to be named `requirements.txt`. You can point the `python_requirements` macro at any other name:\n\n```\npython_requirements(\n    requirements_relpath=\"custom-requirements.txt\",\n)\n```"
}
[/block]
...
[block:api-header]
{
  "title": "Defining inline requirements"
}
[/block]
