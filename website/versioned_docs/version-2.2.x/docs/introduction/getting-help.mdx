...
There are various channels, but the `#general` channel is a good place for most questions. A friendly person may then point you to an even better channel for your specific question.
## Mailing list
