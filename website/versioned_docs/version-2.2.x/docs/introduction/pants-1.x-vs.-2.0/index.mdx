...
{
  "type": "success",
  "title": "New user? you can skip this page",
  "body": "This page is intended for current Pants users still on the 1.x series. If you are trying Pants for a new project, you should already be using Pants 2.0, so you can ignore this page."
}
[/block]
...
See [here](doc:how-to-upgrade-pants-2-0) for help on upgrading to Pants 2.0.