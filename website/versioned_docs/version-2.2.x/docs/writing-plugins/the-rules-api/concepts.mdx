...
```python title="tab={"label":"pants-plugins/fortran/register.py"}"
...
```python title="tab={"label":"pants-plugins/fortran/fmt.py"}"
...
```python title="tab={"label":"pants-plugins/fortran/test.py"}"
from pants.engine.rules import collect_rules, rule
