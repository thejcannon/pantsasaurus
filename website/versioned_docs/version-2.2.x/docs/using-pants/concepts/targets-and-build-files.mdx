...
[block:callout]
{
  ...
  "body": "If the target name is the same as the name of the directory containing it, then you can omit the target name. For example, `helloworld/greet` is an abbreviated form of `helloworld/greet:greet`."
}
[/block]
