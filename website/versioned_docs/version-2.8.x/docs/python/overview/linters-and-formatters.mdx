...
See [`[pylint].source_plugins`](reference:reference-pylint#section-source-plugins) for instructions to add plugins written by you.

If you want to write first-party plugins for other linters like Flake8, let us know on [Slack](../../getting-help/getting-help.mdx).
