...
[block:api-header]
{
  "title": "Skipping a formatter or linter"
}
[/block]
...
See [`[pylint].source_plugins`](https://www.pantsbuild.org/docs/reference-pylint#section-source-plugins) for instructions to add plugins written by you.

If you want to write first-party plugins for other linters like Flake8, let us know on [Slack](doc:getting-help).
