...
<CaptionedImg src={require("/img/pants-py-constraints.png").default}>Result of `./pants py-constraints --summary`, then importing the CSV into Google Sheets.</CaptionedImg>
