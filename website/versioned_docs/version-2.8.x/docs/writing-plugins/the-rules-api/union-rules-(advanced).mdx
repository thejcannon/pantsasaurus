...
<Tabs>
<TabItem value="pants/core/goals/lint.py" label="pants/core/goals/lint.py">
...
<TabItem value="pants-plugins/bash/shellcheck.py" label="pants-plugins/bash/shellcheck.py">
