...
Then, activate the [Linters and formatters](enabling-backends) you'd like to use. Hook up the `fmt` and `lint` goals to your [CI](../../using-pants/using-pants-in-ci.mdx).
