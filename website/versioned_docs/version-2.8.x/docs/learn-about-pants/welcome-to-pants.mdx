...
[block:callout]
{
  "type": "info",
  "title": "Pants 1 vs. 2",
  "body": "This documentation is for Pants 2, which is a ground-up redesign of Pants based on lessons from the past 10 years of development. See [here](https://v1.pantsbuild.org/) for Pants v1 documentation."
}
[/block]
