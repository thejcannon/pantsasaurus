...
| `pants.backend.experimental.docker` | Enables building, running, and publishing Docker images. | [Docker overview](doc:docker) |
| `pants.backend.experimental.docker.lint.hadolint` | Enables Hadolint, a Docker linter: https://github.com/hadolint/hadolint | [Docker overview](doc:docker) |
...
| `pants.backend.python.typecheck.mypy` | Enables MyPy, the Python type checker: https://mypy.readthedocs.io/en/stable/. | [check](doc:python-check-goal) |
