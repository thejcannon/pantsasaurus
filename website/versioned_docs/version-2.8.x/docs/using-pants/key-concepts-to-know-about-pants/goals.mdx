...
To see if a goal has any options, run `./pants help $goal` or `./pants help-advanced $goal`. See [Command Line Help](../../getting-help/getting-help.mdx) for more information.
