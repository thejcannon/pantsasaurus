...
Pants is currently focused on Python, Go, Java, Scala, Shell, and Docker, with more languages and frameworks coming soon. [The Pants community](/404) is friendly and helpful and welcomes involvement of anyone who is interested in creating modern software development tooling.
...
- Pants [ships](page:language-support) with support for [Python](/404), [Go](../go/go.md), [Java](/404), [Scala](/404) and [Shell](/404).
...
- Pants can create standalone binaries, [Docker images](../docker/docker.md), AWS Lambdas and GCP Cloud Functions

We're listening to the community for which languages, frameworks and tools we should support next, so let us know about your needs by [opening an issue](https://github.com/pantsbuild/pants/issues/new/choose) on GitHub or [chatting with us](/404) about it on the community Slack!  
Pants was designed for extensibility, and we welcome [contributions](../contributing-to-pants/contributor-overview.md)!
