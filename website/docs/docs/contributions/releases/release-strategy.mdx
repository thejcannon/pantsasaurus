...
:::note Tip: join the mailing group for release announcements
    ...
    See [Community](../../getting-help/the-pants-community/index.mdx).
...
:::caution Stable releases may still have bugs
    ...
    If you encounter a bug, please gently let us know by opening a GitHub issue or messaging us on Slack. See [Community](../../getting-help/the-pants-community/index.mdx).
