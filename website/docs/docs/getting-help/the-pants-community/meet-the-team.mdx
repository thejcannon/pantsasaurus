...
| **Raúl Cuza**           | "The first time I was able to help someone else with pants on the Slack [https://pantsbuild.slack.com](https://pantsbuild.slack.com)." |
