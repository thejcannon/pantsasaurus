...
:::caution Alpine Linux is not yet supported
    ...
    If you need to run Pants on Alpine, [let us know](../../getting-help/the-pants-community/index.mdx), so we can prioritize this work. Meanwhile, you can try [building Pants yourself](./manual-installation.mdx#building-pants-from-sources) on Alpine.
