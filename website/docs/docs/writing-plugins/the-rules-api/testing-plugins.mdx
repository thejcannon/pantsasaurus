...
:::caution Confusing rule graph error?
    ...
    Please feel free to reach out on [Slack](../../getting-help/the-pants-community/index.mdx) for help with figuring out how to get things working.
