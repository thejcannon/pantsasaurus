...
:::note Reminder: ask for help
    ...
    We would love to help you with your plugin. Please reach out through [Slack](../../getting-help/the-pants-community/index.mdx).
...
We encourage you to reach out in #plugins on [Slack](../../getting-help/getting-help.mdx) for help.
