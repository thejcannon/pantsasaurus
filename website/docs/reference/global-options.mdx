...
Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[GLOBAL]`</span>
...
<Option
  ...
  default_repr='$XDG_CACHE_HOME/lmdb_store'
>
...
<Option
  ...
  default_repr='$XDG_CACHE_HOME/named_caches'
>
...
<Option
  ...
  deprecated_hint='Use the `keep_sandboxes` option instead.'
>
...
<Option
  ...
  deprecated_hint='Unused: use the `remote_store_rpc_timeout_millis` option instead.'
>
...
<Option
  ...
  default_repr='1500'
  deprecated_version='2.19.0.dev0'
  deprecated_hint='Use the `remote_cache_rpc_timeout_millis` option instead.'
>
