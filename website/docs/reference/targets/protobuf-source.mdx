...
backend: <span style="color: green">
  <code>pants.backend.experimental.codegen.protobuf.go</code>
</span>
...
backend: <span style="color: green">
  <code>pants.backend.experimental.codegen.protobuf.java</code>
</span>
...
backend: <span style="color: green">
  <code>pants.backend.codegen.protobuf.python</code>
</span>
...
backend: <span style="color: green">
  <code>pants.backend.codegen.protobuf.lint.buf</code>
</span>
