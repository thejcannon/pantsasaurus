...
Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[export]`</span>
...
<Option
  ...
  default_repr='False'
  deprecated_version='2.20.0.dev0'
  deprecated_hint="Set the `[export].py_resolve_format` option to 'symlinked_immutable_virtualenv'"
>
