...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.python.lint.add_trailing_comma`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[add-trailing-comma]`</span>
