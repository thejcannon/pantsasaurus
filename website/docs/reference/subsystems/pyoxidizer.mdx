...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.python.packaging.pyoxidizer`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[pyoxidizer]`</span>
