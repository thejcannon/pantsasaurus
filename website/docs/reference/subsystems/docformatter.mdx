...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.python.lint.docformatter`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[docformatter]`</span>
