...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.kotlin.lint.ktlint`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[ktlint]`</span>
