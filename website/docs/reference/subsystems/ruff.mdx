...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.python.lint.ruff`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[ruff]`</span>
