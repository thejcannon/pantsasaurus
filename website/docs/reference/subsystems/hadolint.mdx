...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.docker.lint.hadolint`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[hadolint]`</span>
