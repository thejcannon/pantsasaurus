...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.python.typecheck.pytype`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[pytype]`</span>
