...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.tools.yamllint`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[yamllint]`</span>
