...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.scala`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[scalatest]`</span>
