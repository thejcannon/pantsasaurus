...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.python.lint.autoflake`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[autoflake]`</span>
