...
Backend: <span style="color: purple"><code>pants.backend.python.lint.pyupgrade</code></span>
...
### `install_from_resolve`
  ...
  <code>--pyupgrade-install-from-resolve=&lt;str&gt;</code><br>
  <code>PANTS_PYUPGRADE_INSTALL_FROM_RESOLVE</code><br>
</div>
<div style="padding-left: 2em;">
...
### `requirements`
  ...
  <code>--pyupgrade-requirements=&quot;['&lt;str&gt;', '&lt;str&gt;', ...]&quot;</code><br>
  <code>PANTS_PYUPGRADE_REQUIREMENTS</code><br>
</div>
<div style="padding-left: 2em;">
<span style="color: green">default: <code>[]</code></span>
