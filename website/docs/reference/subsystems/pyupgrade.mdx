...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.python.lint.pyupgrade`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[pyupgrade]`</span>
