...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.codegen.protobuf.java`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[protobuf-java-grpc]`</span>
