...
### `install_from_resolve`
  ...
  <code>--ipython-install-from-resolve=&lt;str&gt;</code><br>
  <code>PANTS_IPYTHON_INSTALL_FROM_RESOLVE</code><br>
</div>
...
### `requirements`
  ...
  <code>--ipython-requirements=&quot;['&lt;str&gt;', '&lt;str&gt;', ...]&quot;</code><br>
  <code>PANTS_IPYTHON_REQUIREMENTS</code><br>
</div>
<div style="padding-left: 2em;">
