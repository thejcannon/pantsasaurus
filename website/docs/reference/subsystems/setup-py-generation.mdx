...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.python`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[setup-py-generation]`</span>
