...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.experimental.java.lint.google_java_format`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[google-java-format]`</span>
