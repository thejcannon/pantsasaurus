...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.python.typecheck.mypy`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[mypy]`</span>
