...
Backend: <span style={{ color: "var(--ifm-color-primary)" }}>`pants.backend.awslambda.python`</span>

Config section: <span style={{ color: "var(--ifm-color-primary)" }}>`[lambdex]`</span>
...
<Option
  ...
  deprecated_hint='Remove the whole [lambdex] section, as Lambdex is deprecated and its functionality will be removed. If you have `layout = &quot;zip&quot;`, no further action is required, as you are already using the recommended layout.'
>
